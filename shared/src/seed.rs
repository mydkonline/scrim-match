...
pub fn seed_teams() -> Vec<Team> {
    let mut teams = vec![
        ...
        team("blg-lol", "Bilibili Gaming", "BLG", Game::Lol, "LPL", "BLG Mgmt", &["Coach"],
            &["Bin", "Wei", "Knight", "Elk", "ON"], &LOL_ROLES),
        team("wbg-lol", "Weibo Gaming", "WBG", Game::Lol, "LPL", "WBG Mgmt", &["Coach"],
            &["TheShy", "Tarzan", "Xiaohu", "Light", "Crisp"], &LOL_ROLES),
        team("g2-lol", "G2 Esports", "G2", Game::Lol, "LEC", "G2 Mgmt", &["Coach"],
            &["BrokenBlade", "Yike", "Caps", "Hans Sama", "Mikyx"], &LOL_ROLES),
        team("fnc-lol", "Fnatic", "FNC", Game::Lol, "LEC", "FNC Mgmt", &["Coach"],
            &["Oscarinin", "Razork", "Humanoid", "Noah", "Jun"], &LOL_ROLES),
        team("fly-lol", "FlyQuest", "FLY", Game::Lol, "LCS", "FLY Mgmt", &["Coach"],
            &["Bwipo", "Inspired", "Quad", "Massu", "Busio"], &LOL_ROLES),
        team("c9-lol", "Cloud9", "C9", Game::Lol, "LCS", "C9 Mgmt", &["Coach"],
            &["Thanatos", "Blaber", "Loki", "Zven", "VULCAN"], &LOL_ROLES),
        team("loud-lol", "LOUD", "LOUD", Game::Lol, "CBLOL", "LOUD Mgmt", &["Coach"],
            &["Robo", "Tatu", "tinowns", "Route", "RedBert"], &LOL_ROLES),
        team("pain-lol", "paiN Gaming", "PAIN", Game::Lol, "CBLOL", "PAIN Mgmt", &["Coach"],
            &["Wizer", "CarioK", "Roamer", "TitaN", "Kuri"], &LOL_ROLES),
        team("cfo-lol", "CTBC Flying Oyster", "CFO", Game::Lol, "LCP", "CFO Mgmt", &["Coach"],
            &["Rest", "Gemini", "HongQ", "Doggo", "Kaiwing"], &LOL_ROLES),
        team("dfm-lol", "DetonatioN FocusMe", "DFM", Game::Lol, "LJL", "DFM Mgmt", &["Coach"],
            &["tol2yo", "Steal", "Aria", "Yutapon", "Harp"], &LOL_ROLES),
